...
# ============================================================================
# Training Period: Used for model training (NO DATA LEAKAGE)
TRAIN_START = "2012-01-01"
TRAIN_END = "2021-12-31"

# Backtest Period: Used ONLY for evaluation (OUT-OF-SAMPLE)
BACKTEST_START = "2022-01-01"
BACKTEST_END = "2024-11-01"

# Full Data Period: Used for data download only
DATA_START = "2012-01-01"
DATA_END = "2024-12-31"

# ============================================================================
# STEP 1: Create SUPER Folder
# ============================================================================

def create_super_folder():
    """
    Create an empty SUPER_6assets folder.
    
    Returns:
    None: Creates an empty SUPER_6assets folder
    """
    try:
...
# ============================================================================
# STEP 2: Copy Meta-Agent Backtests to SUPER Folder
# ============================================================================

def copy_backtests_to_super():
    """
    Copy backtest files from Meta_6assets/NLP_obs and Meta_6assets/Metrics_obs to the SUPER_6assets folder.
    
    Returns:
    None: Copies files to the SUPER_6assets folder
    """
    try:
...
# ============================================================================
# STEP 3: Concatenate Meta-Agent Backtests
# ============================================================================

def concatenate_super_backtests(super_dir="SUPER_6assets", 
                                output_file="SUPER_6assets/super_weights_clean.csv"):
    """
    Concatenate the backtest CSV files in the SUPER_6assets folder, keeping only the 'month' and weight columns.
    
    Note: Meta-agent backtests contain full 2012-2024 period.
    Super agent trains on the full 2012-2024 range.
    
    Parameters:
    super_dir (str): Directory containing the backtest CSV files
    output_file (str): Path to save the concatenated and cleaned CSV file
    
    Saves:
    - Concatenated CSV file with only 'month' and weight columns (full 2012-2024 period)
    """
    try:
        ...
        print(f"Metrics backtest has {len(metrics_df)} rows ({metrics_df['month'].min()} to {metrics_df['month'].max()})")
...
# ============================================================================
# STEP 4: Define Super Meta-Agent Environment
# ============================================================================
...
class CustomSuperMetaEnv(gym.Env):
    ...
    This agent takes the weight allocations from both NLP and Metrics meta-agents
    as observations and learns to make final portfolio decisions.
    """
...
def train_super_meta_agent():
    ...
    # Use 1000 timesteps like alpha.py - super agent needs less training
...
# ============================================================================
# STEP 6: Backtest Super Meta-Agent
# ============================================================================
...
def main():
    """
    Run the full super meta-agent pipeline with proper train/test split.
    
    Data Flow:
    1. Meta agents backtest on full 2012-2024 period
    2. Super agent trains on 2012-2024 meta agent backtests (train_mode=True)
    3. Super agent backtests on 2012-2024 meta agent backtests (train_mode=False)
    """
    print("=" * 80)
