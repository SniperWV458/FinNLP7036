...
# ============================================================================
# STEP 1: Create Meta Folder Structure
# ============================================================================
...
# ============================================================================
# STEP 2: Merge NLP Backtest Results
# ============================================================================
...
def merge_backtest_results_nlp(backtest_dir="backtest_results_nlp_6assets", 
                                ...
                                seeds=SEEDS):
    """
    Merge backtest CSV files for each agent in backtest_results_nlp_6assets, combining all seeds side by side.
    
    Parameters:
    backtest_dir (str): Directory containing backtest results
...
def merge_nlp_obs_results(input_dir="Meta_6assets/NLP_obs", output_dir="Meta_6assets/NLP_obs"):
    """
    Merge the four agent-specific merged CSV files into a single CSV file.
    
    Parameters:
    input_dir (str): Directory containing the agent-specific merged CSV files
    output_dir (str): Directory to save the final merged CSV
...
def clean_nlp_obs_results(input_file="Meta_6assets/NLP_obs/nlp_obs_unclean.csv", 
    ...
    Parameters:
    input_file (str): Path to the input merged CSV file
    output_file (str): Path to save the cleaned CSV file
    
    Saves:
    - Cleaned CSV file with only 'month' and weight columns
    """
    try:
...
# ============================================================================
# STEP 3: Merge Metrics Backtest Results
# ============================================================================
...
def merge_backtest_results_metrics(backtest_dir="backtest_results_6assets", 
                                   ...
                                   seeds=SEEDS):
    """
    Merge backtest CSV files for each agent in backtest_results_6assets, combining all seeds side by side.
...
def merge_metrics_obs_results(input_dir="Meta_6assets/Metrics_obs", output_dir="Meta_6assets/Metrics_obs"):
    ...
    Saves:
    - Merged CSV file as metrics_obs_unclean.csv in output_dir
    """
    try:
        os.makedirs(output_dir, exist_ok=True)
        print(f"Created/Verified output directory: {output_dir}")
...
def clean_metrics_obs_results(input_file="Meta_6assets/Metrics_obs/metrics_obs_unclean.csv", 
    ...
    """
    Clean the merged Metrics observation CSV by keeping only the 'month' and weight columns.
...
# ============================================================================
# STEP 4: Define Meta Agent Environments
# ============================================================================

class CustomMetaEnvMetrics(gym.Env):
    """Custom Gym environment for meta-agent portfolio optimization using Metrics observations."""
...
class CustomMetaEnvNLP(gym.Env):
    """Custom Gym environment for meta-agent portfolio optimization using NLP observations."""
...
# ============================================================================
# STEP 5: Train Meta Agents
# ============================================================================

def train_meta_agent_metrics():
    """Train the meta-agent using Metrics observations and save the model."""
...
def train_meta_agent_nlp():
    """Train the meta-agent using NLP observations and save the model."""
...
def main():
    """
    Run the full meta-agent pipeline with proper train/test split.
    
    Data Flow (Leak-Free):
    1. Base agents (rl_train_nlp_6assets.py) backtest on full 2012-2024 period
    2. Meta agents train on 2012-2019 base agent backtests (train_mode=True)
    3. Meta agents backtest on 2020-2024 base agent backtests (train_mode=False)
    """
    print("=" * 80)
